...
//
//     final singleDoctorModel = singleDoctorModelFromJson(jsonString);

import 'dart:convert';

SingleDoctorModel singleDoctorModelFromJson(String str) =>
    SingleDoctorModel.fromJson(json.decode(str));

String singleDoctorModelToJson(SingleDoctorModel data) =>
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        similarDoctor: json["similarDoctor"] == null
            ? []
            : List<Doctor>.from(
                json["similarDoctor"]!.map((x) => Doctor.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "doctor": doctor?.toJson(),
        "similarDoctor": similarDoctor == null
            ? []
            : List<dynamic>.from(similarDoctor!.map((x) => x.toJson())),
      };
}
